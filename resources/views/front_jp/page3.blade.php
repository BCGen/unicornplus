        ...
        <div class="modal-content">
            ...
            <div class="content-box">
                ...
                <div class="modal-header">
                    ...
                    <div class="tittle_jp">{{ $classCard->title }}</div>
                </div>

                <div class="main-content-box">
                    <div class="main-content">
                        <p class="message-content_jp">{{ $classCard->main_content }}</p>
                    </div>
                </div>
                ...
                <div class="TimeLine row no-gutters">
                    ...
                    <div class="time-box col-xl-9 col-lg-9 col-md-9 col-sm-9 col-9">
                        ...
                        <div class="row time no-gutters" onmouseover="mouseOver(this, {{ $classCard->id }})">
                            ...
                            <div class="col-xl-2 col-lg-2 col-md-2 col-sm-2 col-2 TimeLineClock_jp">{{ $class->time }}</div>
                            <div class="col-xl-1 col-lg-1 col-md-1 col-sm-1 col-1"></div>
                            <div class="col-xl-8 col-lg-8 col-md-8 col-sm-8 col-8 TimeLineText">{{ $class->main_content }}</div>
                        </div>
                        @endforeach
                    </div>
                </div>
...
<div class="container-fluid page-3">
    <div class="row no-gutters">
        ...
        <!-- Swiper -->
        <div class="swiper-container swiper-cards-container d-xl-block d-none">
    ...
    <div id="SchoolEnvironment" class="School">
        <div class="d-xl-block d-none">
                ...
                <div class=" opacity-box">
                    <div class="color-box">
                        <div class="color-box-yellow">
                            <div class="color-box-tittle color-box-tittle_jp">
                                <h1 data-aos="fade-up">学校環境</h1>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <!-- -----------------內容swiper--------------------------------------------- -->
            <div class="swiper-container swiper-school-content swiper-school-content_jp">
                <div class="swiper-wrapper">
                    @foreach ($schoolEnvironments as $environment)
                    <div class="swiper-slide swiper-school-slide">
        ...
        <div class="d-xl-none d-block">
            <div class="swiper-container swiper-school-content-min swiper-school-content-min_jp">
                <div class="color-box-tittle-1 color-box-tittle-1_jp">
                    <h1>学校環境</h1>
                </div>
                <div class="swiper-wrapper">
                    @foreach ($schoolEnvironments as $environment)
                    <div class="swiper-slide swiper-school-slide">
                        ...
                        <div class="Environment Environment_jp">
                            <h4>{{ $environment->title }}</h4>
                            <p>{{ $environment->main_content }}</p>
                        </div>
                    </div>
            ...
            <div class="swiper-container swiper-school-img-min">
                ...
                <div class="swiper-wrapper">
                    ...
                    <div class="swiper-slide swiper-school-slide">
                        <div class="row no-gutters">
                            <!-- <div class="col-xl-4 col-lg-4 d-lg-block d-none"></div> -->
                            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 school-bg" style="background-image: url({{ $environment->image_url }})">
                            </div>
                        </div>
                    </div>
                    @endforeach
